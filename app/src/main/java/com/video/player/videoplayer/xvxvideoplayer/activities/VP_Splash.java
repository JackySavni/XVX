    ...
    private void adIdLoad() {
        ...
        dataRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                vp_SharePrefEditor.putBoolean("1NativeTrendOutSide", Boolean.TRUE.equals(snapshot.child("1NativeTrendOutSide").getValue(Boolean.class)));
                vp_SharePrefEditor.putBoolean("1RemoveAllAds", Boolean.TRUE.equals(snapshot.child("1RemoveAllAds").getValue(Boolean.class)));
                vp_SharePrefEditor.putString("pPolicy", snapshot.child("pPolicy").getValue(String.class));
                vp_SharePrefEditor.apply();

                if (!RemoveAllAds(VP_Splash.this)) {
