...
public class VP_MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        AdSettings.addTestDevice("4dcf9289-404a-42a5-919c-0d38cdcebbb1");
    ...
    //    TrendSecure
    public static int vp_getTrendSecurityQuestion() {
        return vp_preferences.getInt("trend_security_question", 0);
    }

    public static void vp_putTrendSecurityQuestion(int str) {
        vp_prefEditor.putInt("trend_security_question", str);
        vp_prefEditor.apply();
    }
