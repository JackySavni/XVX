...
import static com.video.player.videoplayer.xvxvideoplayer.util.VP_SharePref.fbInterAd1;
...
public class VP_TrendSecurityQuestion extends AppCompatActivity {
    ...
    private void initView() {
        ...
        if (!RemoveAllAds(this)) {
            ...
            vp_nativeContainer.setVisibility(View.GONE);
        }
        ...
        if (this.vp_type == 1) {
            this.vp_questionSpinner.setSelection(VP_MyApplication.vp_getTrendSecurityQuestion());
            this.vp_questionSpinner.setEnabled(false);
        }
        vp_saveQuestion.setOnClickListener(view -> {
            String obj = vp_securityAnswer.getText().toString();
            ...
            if (!VP_MyApplication.vp_getTrendSetQuestion()) {
                ...
                VP_MyApplication.vp_putTrendSecurityQuestion(vp_questionSpinner.getSelectedItemPosition());
        ...
        vp_backquestion.setOnClickListener(view -> onBackPressed());
    }
