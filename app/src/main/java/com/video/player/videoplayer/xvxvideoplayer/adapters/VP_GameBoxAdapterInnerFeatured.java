...
public class VP_GameBoxAdapterInnerFeatured extends RecyclerView.Adapter<VP_GameBoxAdapterInnerFeatured.MyViewHolder> {
    Activity vp_context;
    private ArrayList<VP_GameModel> vp_arrayList;

    public VP_GameBoxAdapterInnerFeatured(Activity vp_context, ArrayList<VP_GameModel> vp_arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                                       int viewType) {
        View view = LayoutInflater.from(vp_context).inflate(R.layout.vp_games_raw_layout_featured, parent,
                false);
    ...
    class ItemViewHolder extends MyViewHolder {
        ...
        public void setThumb(String gameThumb) {
            ImageView vp_thumb_image = (ImageView) vp_mView.findViewById(R.id.vp_game_thumb);
            Picasso.get().load(gameThumb).into(vp_thumb_image);
        }
    }
}
